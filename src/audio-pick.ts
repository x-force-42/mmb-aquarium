 ...
 */
export const WEIGHT_MATRIX: Readonly<Record<Mood, Readonly<Record<AudioId, number>>>> = Object.freeze({
  ...
  newborn: Object.freeze({
    imMrMeeseeks: 1, mrMeeseeks: 0, lookAtMe: 0, canDo: 0,
    excuseMe: 0, letMeTry: 0, ohOk: 0,
    mistakesDontExistThisLong: 0, iJustWantToDie: 0, allDone: 0,
  }),
  healthy: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 1, canDo: 4,
    excuseMe: 2, letMeTry: 2, ohOk: 0,
    mistakesDontExistThisLong: 0, iJustWantToDie: 0, allDone: 0,
  }),
  declining: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 0, canDo: 1,
    excuseMe: 3, letMeTry: 3, ohOk: 1,
    mistakesDontExistThisLong: 1, iJustWantToDie: 0, allDone: 0,
  }),
  critical: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 0, canDo: 0,
    excuseMe: 1, letMeTry: 1, ohOk: 2,
    mistakesDontExistThisLong: 3, iJustWantToDie: 1, allDone: 0,
  }),
  freakingOut: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 0, canDo: 0,
    excuseMe: 0, letMeTry: 1, ohOk: 0,
    mistakesDontExistThisLong: 4, iJustWantToDie: 3, allDone: 0,
  }),
  recovered: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 0, canDo: 4,
    excuseMe: 1, letMeTry: 1, ohOk: 4,
    mistakesDontExistThisLong: 0, iJustWantToDie: 0, allDone: 0,
  }),
  dyingHappy: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 0, canDo: 0,
    excuseMe: 0, letMeTry: 0, ohOk: 0,
    mistakesDontExistThisLong: 0, iJustWantToDie: 0, allDone: 1,
  }),
  dyingDefeated: Object.freeze({
    imMrMeeseeks: 0, mrMeeseeks: 0, lookAtMe: 0, canDo: 0,
    excuseMe: 0, letMeTry: 0, ohOk: 0,
    mistakesDontExistThisLong: 3, iJustWantToDie: 5, allDone: 0,
  }),
});
...
export function pickChain(
  ...
  switch (primary) {
    ...
    case 'canDo':
      if (mood === 'healthy' && r < 0.10) return 'letMeTry';
      return null;
    ...
    case 'letMeTry':
      if ((mood === 'critical' || mood === 'freakingOut') && r < 0.30) {
        return 'mistakesDontExistThisLong';
      }
      return null;

    case 'mistakesDontExistThisLong':
      if (mood === 'freakingOut' && r < 0.20) return 'iJustWantToDie';
      return null;
